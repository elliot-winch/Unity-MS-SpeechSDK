...
namespace FactualVR
{
    ...
    public class FactualSpeechManager : MonoBehaviour
    {
        ...
        [Tooltip("Use the old Bing API (false) or the new Cognitive Services (true)")]
        [HideInInspector] //to reduce clutter - old API is legacy
        public bool useNewCognitiveAPI = true;

        public Action<SpeechServiceResult> MessageReceived;
        public Action<string> OnError;
        public Action OnBeginVoice;
        public Action OnEndVoice;
